...
def test_mongodb_directives(backend: Backend) -> None:
    ...
    check_ast_testing_string(
        ...
        """<directive domain="mongodb" name="card-group" columns="3" style="compact" layout="carousel">
            <directive domain="mongodb" name="card" headline="Run a self-managed database" cta="Get started with MongoDB" url="http://mongodb.com" icon="/images/pink.png" icon-alt="Alt text" tag="server">
                <paragraph><text>Download and install the MongoDB database on your own\ninfrastructure.</text></paragraph>
            </directive>
            <directive domain="mongodb" name="card" cta="Call to action" url="https://www.url.com" icon="/images/pink.png" icon-alt="Alt text">
